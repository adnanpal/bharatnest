...
export default function SafediXWebsite() {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
            {[
              ...
              {
                icon: <Mail className="w-6 sm:w-8 h-6 sm:h-8 text-teal-600" />,
                title: 'Email Us',
                content: 'bharatnestconsumer@gmail.com',
  ...
  className="text-teal-600 hover:underline break-all text-sm sm:text-base"
>
  {item.content}
</a>
              </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="intent://compose?to=bharatnestconsumer@gmail.com#Intent;scheme=mailto;package=com.google.android.gm;end"
                    className="hover:text-orange-400"
                  >
                    Email via Gmail
                  </a>
